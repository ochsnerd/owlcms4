...
64.2.1: Fixed total tie-break ordering for equal totals.
  - In the same session, the athlete with the higher snatch now correctly ranks ahead because they reached the total earlier.
